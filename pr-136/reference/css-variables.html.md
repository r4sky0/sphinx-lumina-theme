...
| `--lumina-accent`          | `#10b981`       | `#10b981`      | Brand accent for decorative details. Also overridable through the `accent_color` theme option. |
| `--lumina-accent-text`     | `#047857`       | `#34d399`      | Accessible text links and selected navigation states.                                          |
| `--lumina-accent-solid`    | `#047857`       | `#047857`      | Filled controls and selected-result badges.                                                    |
| `--lumina-accent-on-solid` | `#ffffff`       | `#ffffff`      | Text placed on `--lumina-accent-solid` surfaces.                                               |
| `--lumina-accent-focus`    | `#047857`       | `#34d399`      | Keyboard focus indicators.                                                                     |
