...
# <<<<<<< Updated upstream<br/>Lumina lets the main content column use the space available between the navigation and page outline. Normal prose is capped at 70ch; wide mode expands it to 80ch, while code, tables, and diagrams can use the full column. If your documentation is code-heavy or includes wide tables, you can enable a wider layout that expands the page wrapper from 90rem to 100rem.
