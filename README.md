...
[![License](https://img.shields.io/github/license/ralph089/sphinx-lumina-theme)](https://github.com/ralph089/sphinx-lumina-theme/blob/main/LICENSE)
[![Docs](https://img.shields.io/badge/docs-GitHub%20Pages-blue)](https://ralph089.github.io/sphinx-lumina-theme/)

A modern, clean Sphinx documentation theme built with **Tailwind CSS v4** and **Alpine.js**.

**[View the documentation →](https://ralph089.github.io/sphinx-lumina-theme/)**
...
For configuration options and customization, see the [documentation](https://ralph089.github.io/sphinx-lumina-theme/).

## Development

```bash
git clone https://github.com/ralph089/sphinx-lumina-theme.git
